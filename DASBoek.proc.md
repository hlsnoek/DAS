...
<center>$${ f(x) = \frac{1}{\sigma \sqrt{2 \pi}} e^{-\frac{1}{2}(\frac{x-\mu}{\sigma})^2} }.$$</center>
...
<center>$${ \chi^2 = \sum_{i=1}^N \left( \frac{y_i - f(x_i;a)}{\sigma_i}\right)^2 }$$</center>
...
<center>$${ \frac{\partial \chi^2}{\partial a} =0}$$</center>\newline

Dit geeft: 

<center>$${ \frac{\partial \chi^2}{\partial a} = \sum_{i=1}^N \frac{1}{\sigma_i^2} \frac{\partial f(x_i;a)}{\partial a} \left( y_i - f(x_i;a)\right) = 0 }$$</center>
...
<center>$${  \chi^2 = \sum^N_{i=1} \left( \frac{y_i-f(x_i;\hat{a},\hat{b},..)}{\sigma_i} \right)^2.}$$ </center>
...
Hieronder zie je hoe de $$\chi^2$$ eruit ziet voor verschillende waardes van $$df$$. \newline 

![](ChiSquareDistributie.png){:width="80%"}\newline
\caption{}
...
<center>$${ s_{n} = \sigma/\sqrt{n}.}$$</center>\newline
