...
$${\displaystyle \text{P(gevaarlijke brand \mid rook)} = \frac{\text{P(rook \mid gevaarlijke brand)}\cdot{\text{P(gevaarlijke brand)}}}{\text{P(rook)}} = \frac{0.9 \times 0.01}{0.10} = 0.09}$$<br></span>
