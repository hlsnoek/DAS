...
en ik wil het gemiddelde van ratio,  $$\overline{R}$$ bepalen. Van een andere, vergelijkbare, dataset heb de volgende gemiddeldes bepaald: $$\overline{M} = 210 \pm 24$$ gram en $$\overline{L} = 25 \pm 8$$ meter.  Bereken voor deze waardes de ratio $$\overline{R}$$ en de onzekerheid hierop $$\Delta \overline{R}$$. Schrijf de hele berekening uit.
