...
# Foutenpropagatie
<!--REF\label{/module-1/foutenpropagatiei}-->
...
> Dit noem je ook wel de voorwaardelijke kans:<br> 
> $$P({\text{reiger}}\_{\text{m}}\_{\text{laag}} < {\text{m}} < {\text{reiger}}\_{\text{m}}\_{\text{hoog}} \mid {\text{purperreiger}})$$. <br>
> Voor het gemak noteren we dit even als $$P(m_{\text{obs}} \mid \text{purperreiger} )$$. <br>
