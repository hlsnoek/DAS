...
![higgs1](Higgs_figuur_fig1.PNG#thumbnail)![higgs2](Higgs_figuur_fig2.PNG#thumbnail)
img[src*="#thumbnail"] {
   width:150px;
   height:100px;
}
...
![higgs](Basisbegr_Normaleverd_BiModaal.png){:width="45%"}![higgs](Basisbegr_Normaleverd_MultiModaal.png){:width="45%"}
