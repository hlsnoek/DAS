...
> * Bereken voor elke waarde van $$m_0$$ nu de p-waarde en representeer deze in een plot. 
> * Bij welke waarde van $$m_0$$ vindt je de beste p-waarde in jouw massa gebied?
> * Maak voor een plotje met de dataset en de gefitte functies (achtergrond en achtergrond+signaal) voor deze waarde van $$m_0$$. Gebruik hiervoor de volgende plot opties om de grafiek duidelijker te maken: 
> 
>		plt.yscale('log')
>		plt.grid(True)
>
> * Hoe klein is de p-waarde voor deze waarde van $$m_0$$?
