...
> * Combineer nu de gegevens en bereken de kansen $${P(\text{m_obs en w_obs} 
> | \text{koolmees})}$$ en $${P(\text{m_obs en w_obs} | \text{pimpelmees})}$$.
...
> * Bereken nu de kans dat het inderdaad een pimpelmeesje is geweest: $$P(\text{koolmees}
> | m_\text{obs en } w_{\text{obs}})$$. Maak hierbij gebruik van de [vergelijking](/blok-2/extra-kansrekenregels) van Bayes.
