...
## Opdracht B1b.A - Halfwaardedikte I *
...
We gaan het experiment nu simuleren. Download het bestand [B1b.A_Halfwaardedikte.py](B1b.A_Halfwaardedikte.py) en zorg dat deze in dezelfde folder staat als *DAS_DatasetGenerator.py*. Download ook het inlever template: [Inlevertemplate](InlevertemplateBlok1b.docx)
