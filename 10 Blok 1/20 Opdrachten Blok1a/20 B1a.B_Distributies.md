...
We gaan in deze opgave kijken naar kansdichtheid distributies. Lees [hier](/blok-1/kanstheorie) meer over kansdichtheid distributies. Er zijn een paar belangrijke, en bekende, distributies. We gaan in deze opgave aan de slag met de <a href="/blok-1/kanstheorie#Poisson">poisson</a> en <a href="#Uniform">uniforme</a> distributies.
...
>
> * Waarschijnlijk komt niet elke mogelijke uitkomst evenveel keer voor in je dataset. Hoe verwacht je dat de uitkomsten verdeeld zijn? Als je het experiment opnieuw zou doen, wat is dan de kans dat je maar 1 keer een 6 zult gooien. Gebruik hiervoor de <a href="Poisson">Poisson kans</a> (deze kans moet je berekenen en kun je niet aflezen uit je histogram). 
>
