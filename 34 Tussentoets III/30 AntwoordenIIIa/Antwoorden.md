...
We vinden de optimale waarde voor $$b$$ door de afgeleide van de $$\chi^2$$ op nul te stellen:
...
Invullen:
$$(2.0\cdot -1.1 - 2.0\cdot 2.0 - \hat{b} \cdot 2.0^2)$$ +  $$(4.0\cdot -5.4 - 2.0\cdot 4.0 - \hat{b} \cdot 4.0^2) + (6.0\cdot -13.3 - 2.0 \cdot 6.0 - \hat{b} \cdot 6.0^2) = 0$$ geeft $$\hat{b} = -2.35$$
</span>
