...
De antwoorden van de opdrachten moet je invoeren in [een template](https://das.proglab.nl/course/22%20Opdrachten%20Module%202/00%20Opdrachten/InlevertemplateModule2.docx) en als **pdf** bestand inleveren samen met de code voor de 3 opdrachten via ANS. De deadlines voor de inleveropdrachten en informatie over ANS kun je [hier](/informatie/inleveropdrachten) vinden.
