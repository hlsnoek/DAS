...
> Dit noem je ook wel de voorwaardelijke kans $$P($$\text{mees_m_laag}$$ < m < $$\text{mees_m_hoog}$$ \mid \text{koolmees})$$. Voor het gemak noteren we dit even als $$P(m_{\text{obs}} \mid \text{koolmees} )$$. Zie ook het hoofdstuk over [Extra Kansrekenregels](/module-2/extra-kansrekenregels) 
>
