...
de spreiding van een dataset aan. Bij een 2D dataset waarbij een grootheid wordt aangegeven op de $$x$$-as en een andere
grootheid op de $$y$$-as wordt de mate van spreiding o.a. aangegeven met de *covariantie*.
...
Hierbij is $$cov(x,y)$$ de covariantie tussen grootheid $$x$$ en grootheid $$y$$, en zijn $$\sigma_x$$ en $$\sigma_y$$ de standaardafwijkingen van grootheid $$x$$ en $$y$$ respectievelijk.
