...
![Venn diagrammen.](Venn.png){:width="80%"}
...
## Conditionele kans
Een conditionele kans wordt geschreven als $$P(A \mid B)$$ en kun je lezen als "Wat is de kans op meting A gegeven dat B is gemeten". 
Let op dat je een conditionele kans niet zomaar kan omkeren: $$P(A \mid B)\neq P(B \mid A)$$!  
